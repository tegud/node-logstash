...
function FilterMapData() {
  ...
  this.config = {
	...
	optional_params: ['allowOverwrite']
  }
}
...
FilterMapData.prototype.process = function(data) {
  if (data['@fields'] && data['@fields'][this.source_field] && (!data['@fields'][this.field_name] || this.allowOverwrite)) {
	...
	if (result && result.length > 0) {
        ...
        data['@fields'][this.field_name] = this.defaultValue;
	}
  }
