...
util.inherits(OutputStatsd, base_output.BaseOutput);

OutputStatsd.prototype.afterLoadConfig = function(callback) {
...
OutputStatsd.prototype.process = function(data) {
...
OutputStatsd.prototype.close = function(callback) {
